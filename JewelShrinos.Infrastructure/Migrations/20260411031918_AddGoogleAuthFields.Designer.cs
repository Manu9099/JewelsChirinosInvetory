...
namespace JewelShrinos.Infrastructure.Migrations
{
    ...
    [Migration("20260411031918_AddGoogleAuthFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JewelShrinos.Core.Entities.Return", b =>
                {
                    ...
                    b.HasIndex("ReturnNumber")
                        .IsUnique()
                        .HasDatabaseName("ux_returns_return_number");

                    b.HasIndex("ReturnStatus")
                        .HasDatabaseName("idx_returns_return_status");
            ...
            modelBuilder.Entity("JewelShrinos.Core.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("JewelShrinos.Core.Entities.InventoryMovement", b =>
                {
                    ...
                    b.HasOne("JewelShrinos.Core.Entities.User", null)
                        .WithMany("InventoryMovements")
